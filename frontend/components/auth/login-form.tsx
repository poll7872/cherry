    ...
    <div className={cn("flex flex-col gap-8 w-full", className)} {...props}>
      <div className="flex flex-col items-start gap-4">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground font-sans max-w-[340px] leading-relaxed">
            Ingresa a tu entorno de trabajo para continuar con tu producción
            científica.
          </p>
        </div>
      </div>
        ...
        <form action={action}>
          <FieldGroup className="gap-6">
            <Field>
              <FieldLabel
                htmlFor="email"
                className="text-xs font-bold text-muted-foreground mb-2 flex items-center gap-2"
              >
            ...
            <Field className="pt-4">
              <Button
                ...
                disabled={pending}
              >
                {pending ? "Iniciando sesión..." : "Acceder"}
              </Button>
            </Field>
          </FieldGroup>
        </form>
      ...
      <div className="flex flex-col items-start gap-4">
        ...
        <p className="text-sm text-muted-foreground font-sans">
          ...
          <Link
            href="/auth/signup"
            className="text-foreground font-bold hover:text-primary transition-all underline decoration-primary/40 underline-offset-4"
          >
            Regístrate aquí
          </Link>
        </p>
